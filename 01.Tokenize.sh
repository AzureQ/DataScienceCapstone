...
function tokenization(){
    ...
    java edu.stanford.nlp.process.PTBTokenizer -preserveLines -options untokenizable=noneDelete,normalizeParentheses=false,normalizeOtherBrackets=false < $file | python token_cleaner.py> $output
...
echo "Exporting tokenized files to tokenized_dataset.txt"
cat dataset/en_US/tokenized_en_US.* >> dataset/en_US/tokenized_data.txt
